...
/*********************************************************************
class binaryTreeType - defines binary trees an an ADT.
**********************************************************************/
#include <iostream>
...
public:
	...
	//Postcondtion: Returns true if the binary tree is empty; otherwise, returns false.
	...
	//Postcondiiton: Nodes are printed in preorder sequence.
	...
	//Postcondition: Returns the nubmer of leaves in the binary tree.
	...
	//Postcondition: Returns true if searchItem is found in the binary tree;
	//				 otherwise, returns false.
	
	virtual void insert(const elemType& insertItem) = 0;
	//Function to insert insertItem in the binary tree.
	//Postcondition: If there is no node in the binary tree that has the same
	//				 info as insertItem, a node with the info insertItem is 
	...
	//				 it is deleted from the binary tree. If the binary tree
	//				 is empty or deleteItem is not in the binary tree, an
...
private:
	...
	//Postcondition: Nodes of the binary tree, to which p points, are printed inorder sequence.
	...
	//Fucntion to determine the larger of x and y.
	//Postcondition: returns the larger of x and y.

	int nodeCount(nodeType<elemType> *p) const;
	//Function to determine the number of nodes in the binary tree to which p points.
	//Postcondition: The number of nodes in the binar tree to which p points is returned.
...
const binaryTreeType<elemType>& binaryTreeType<elemType>::operator=(const binaryTreeType<elemType>& otherTree) 
{
	...
	if (this != &otherTree) 
	{
		// if binary tree is not empty, destroy the binary tree
		if (root != NULL) 
		{
			destroy(root);
		}
